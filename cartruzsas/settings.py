...
DATABASES = {
    'default': {
        ...
        'NAME': 'cartruzsas.sqlite3',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['cartruzsas.herokuapp.com']
...
SECRET_KEY = 'ip&r7e=d@%&zvkp1xtasuug64+k=&+sl8u#-$7fh&^m-q+j_(#'
...
ROOT_URLCONF = 'cartruzsas.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cartruzsas.wsgi.application'
